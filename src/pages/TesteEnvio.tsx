...
const TesteEnvio = () => {
  ...
  const media = ultimasFichas.length
    ? Math.round(ultimasFichas.reduce((acc, f) => acc + (f.tempo_processamento ?? 0), 0) / ultimasFichas.length)
    : null;
  ...
  return (
    <div className="min-h-screen bg-background pb-20 relative">
      ...
      <main className="px-4 py-6 relative z-10">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-4 items-start">
            ...
            <div className="bg-card rounded-lg p-8 shadow-sm">
              ...
              <div className="text-center mb-8">
                <h2 className="text-xl font-semibold text-foreground mb-2">
                  [TESTE] Capturar Ficha
                </h2>
                <p className="text-muted-foreground text-sm">
                  OCR direto via OpenAI. Tire uma foto ou carregue uma imagem.
                </p>
              </div>
              ...
              <div className="space-y-3 mb-6">
                ...
                >
                  ...
                  {isUploading ? "Enviando..." : "[Teste] Tirar Foto"}
                </Button>
              ...
              <button className="w-full py-3 text-amber-600 hover:text-amber-800 transition-colors flex items-center justify-center gap-2">
              ...
              {ultimasFichas.length === 0 ? (
                ...
                <>
                  <div className="space-y-2 mb-4">
                    {ultimasFichas.map((f) => (
                      <div key={f.id} className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-mono font-medium text-amber-600 ml-4 shrink-0">
                  ...
                  <div className="border-t border-border pt-3 flex items-center justify-between">
                    ...
                    <span className="font-mono font-bold text-amber-600">{media}s</span>
                  </div>
                </>
              )}
            </div>
                  ...
                  {errosRecentes.map((f) => (
                    <div key={f.id} className="flex items-center justify-between text-sm">
                      ...
                      <button
                        ...
                        className="ml-4 shrink-0 text-xs text-amber-600 hover:text-amber-800 underline"
                      >
                        ver
                      </button>
                    </div>
